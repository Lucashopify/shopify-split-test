      ...
      <section style={{ marginBottom: "2rem" }}>
        ...
        <div style={{ border: "1px solid #e9e9e9", borderRadius: 8, padding: "1.25rem" }}>
          ...
          <p style={{ fontSize: "0.8125rem", color: "#777", margin: "0 0 0.875rem", lineHeight: 1.6 }}>
            The Arktic embed loads the tracking script on every storefront page. Without it, no experiments will run.
          </p>
          <a
            href={themeEditorUrl}
            target="_blank"
          ...
          <p style={{ fontSize: "0.75rem", color: "#bbb", margin: "0.625rem 0 0", lineHeight: 1.5 }}>
            In the Theme Editor, go to <strong style={{ color: "#999" }}>App embeds</strong> and toggle on <strong style={{ color: "#999" }}>Arktic</strong>, then save.
          </p>
        </div>
      </section>
